...
class TranslationDictionary(IDictionary):
    ...
    def apply_dictionary(
        ...
        elif source_language in ["en", "english", "英文"] or self._is_english_text(
            text
        ):
            # 英文到中文
    ...
    def list_entries(
        ...
        Returns:
            词典条目字典。当lang_direction为'zh_to_en'或'en_to_zh'时返回Dict[str, str]，
...
def apply_translation_dictionary(
    text: str, source_language: str = "auto", target_language: str = "auto"
) -> str:
    """应用翻译词典到文本
