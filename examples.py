...
def example_1_translate_bilibili_video():
    ...
    output_video = translator.translate_video(
        url_or_path=bilibili_url, target_language="English"
    )
...
def example_2_translate_local_video():
    ...
    # 翻译为日文,指定源语言为中文
    output_video = translator.translate_video(
        url_or_path=local_video, target_language="Japanese", source_language="Chinese"
    )
...
def example_4_custom_config():
    ...
    translator = VideoTranslator()
    output_video = translator.translate_video("test.mp4", "English")
